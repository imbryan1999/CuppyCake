                        ...
                        <form action="changepasscode.jsp">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputPassword">Enter Current Password</label>
                                    <input type="password" class="form-control" id="inputPassword" name="txtpwd" placeholder="Current Password" required = "true">
                                    <h5 id="checkpass"></h5>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="password" class="form-control" id="inputPassword" placeholder="New Password" name="txtnpwd" required = "true">
                                    <h5 id="checkpass"></h5>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="password" class="form-control" id="inputPassword" name="txtcpwd" placeholder="Confirm Password" required = "true">
                                    <h5 id="checkpass"></h5>
                                </div>
                            </div>
                            <div class="form-row justify-content-center">
                                <div class="form-group col-6 p-4">
                                    <button class="btn btn-outline-success btn-block p-2">Change Password</button>
                                </div>
                                <div class="form-group col-6 p-4">
