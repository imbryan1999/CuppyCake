                    ...
                    <form action="feedbackcode.jsp">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="subject" name="sub" placeholder="Subject" required = "true">
                                <h5 id="checksub"></h5>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control" id="message" placeholder="Message" name="msg" rows="5" required = "true"></textarea>
                                <h5 id="checkmsg"></h5>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12">
                                <label for="usernm">Reply Name</label>
                                <input type="text" class="form-control" id="usernm" placeholder="Your Name" name="usernm" required = "true">
                                <h5 id="checkuser"></h5>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12">
                                <label for="rplyemail">Reply Email</label>
                                <input type="email" class="form-control" id="email" name="mail" placeholder="Email ID" required = "true">
                                <h5 id="checkmail"></h5>
                            </div>
                        </div>
                        <div class="form-row justify-content-center">
                            <div class="form-group col-6 p-4">
                                <button class="btn btn-outline-success btn-block p-2">Send Message</button>
                            </div>
                            <div class="form-group col-6 p-4">
                                <button class="btn btn-outline-danger btn-block" type="reset">Reset</button>
                            </div>
                        </div>
                    </form>
