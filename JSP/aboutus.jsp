    ...
    <section class="breadcrumbs-section">
        ...
        <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../images/aboutus.jpeg" style="height: 200px;" class="d-block w-100" alt="StrawBerry">
                </div>
                <div class="carousel-caption text-dark" style="font-family: fantasy">
                    <h1>ABOUT US</h1>
                </div>
        </div>
        ...
        <div class="container-fluid jumbotron mt-4">
            <div class="row">
                <div class="col-12">
                    <p class="text-center">
                        In using the CuppyCake.in shopping service, you (The User) are deemed to have accepted the terms and conditions listed below. CuppyCake.in reserves the right to add, delete, alter or modify these terms and conditions at any time. The User is therefore advised to read carefully these terms and conditions each time he or she uses the shopping service(s) of CuppyCake.in .
onlinecake.in reserves the right to accept or reject your offer.
                    </p>
                </div>
            </div>
        </div>
